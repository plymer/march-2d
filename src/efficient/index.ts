...
import { fillGrid, fillGridTypedArray } from "../utils/mockup.js";
import { marchingSquares, marchingSquaresEfficient } from "./helpers.js";
...
const isolines = marchingSquares(thresholds, typedArrayGriddedData, [initXDim, initYDim]);
